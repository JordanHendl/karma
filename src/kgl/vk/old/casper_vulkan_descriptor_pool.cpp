...
namespace casper
{
  namespace vulkan
  {
    ...
    {
      VkDescriptorType ret_type ;
      switch( type )
      {
        case ::tools::shader::UniformType::UBO     : ret_type =  VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER ; break ;
        case ::tools::shader::UniformType::SAMPLER : ret_type =  VK_DESCRIPTOR_TYPE_SAMPLER        ; break ;
        case ::tools::shader::UniformType::SSBO    : ret_type =  VK_DESCRIPTOR_TYPE_STORAGE_BUFFER ; break ;
        default :                                    ret_type =  VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER ; break ;
      }
...
//    }
    ...
    void DescriptorPool::initialize( unsigned gpu, unsigned num_descriptors, const Shader& shader, const char* pipeline_name )
    {
      ...
      data().device = pool.device( gpu ).device() ;
      ...
      for( auto desc : data().uni_map )
      {
        ...
        sz.descriptorCount = num_descriptors                  ;
        size.push_back( sz )                                  ;
      }
